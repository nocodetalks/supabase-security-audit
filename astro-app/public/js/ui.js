                ...
                <table class="w-full text-13">
                    <thead>
                        <tr class="border-b border-[#eaeaea]">
                            <th class="text-left py-4 px-5 font-medium text-[#000]">Table Name</th>
                            <th class="text-right py-4 px-5 font-medium text-[#000]">Records</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Columns</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Access</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ${tables.map(table => {
                            ...
                            return `
                                <tr class="border-b border-[#eaeaea] hover:bg-[#fafafa] transition-colors">
                                    ...
                                    <td class="py-4 px-5 text-center text-[#666]">${table.columns.length}</td>
        ...
        const html = `
            <div class="overflow-x-auto">
                <table class="w-full text-13">
                    <thead>
                        <tr class="border-b border-[#eaeaea]">
                            <th class="text-left py-4 px-5 font-medium text-[#000]">Function Name</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Parameters</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Return Type</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Auth</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ${functions.map(func => {
                            ...
                            return `
                                <tr class="border-b border-[#eaeaea] hover:bg-[#fafafa] transition-colors">
                                    ...
                                    <td class="py-4 px-5 text-center text-[#666]">${func.parameters.length}</td>
                                    <td class="py-4 px-5 text-center font-mono text-[#666]">${this.escapeHtml(returnType)}</td>
                                    <td class="py-4 px-5 text-center">
        ...
        const html = `
            <div class="overflow-x-auto">
                <table class="w-full text-13">
                    <thead>
                        <tr class="border-b border-[#eaeaea]">
                            <th class="text-left py-4 px-5 font-medium text-[#000]">Bucket Name</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Access</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Can List</th>
                            <th class="text-center py-4 px-5 font-medium text-[#000]">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ${buckets.map(bucket => {
                            ...
                            return `
                                <tr class="border-b border-[#eaeaea] hover:bg-[#fafafa] transition-colors">
                                    ...
                                    <td class="py-4 px-5 text-center text-[#666]">${canList ? 'Yes' : 'No'}</td>
                                    <td class="py-4 px-5 text-center">
